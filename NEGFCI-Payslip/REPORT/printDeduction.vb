...
Public Class printDeduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEGFCI_Payslip.printDeduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintDeduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printDeduction = New printDeduction()
        rpt.Site = Me.Site
        Return rpt
    End Function
