...
Public Class printIncentive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEGFCI_Payslip.printIncentive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintIncentive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printIncentive = New printIncentive()
        rpt.Site = Me.Site
        Return rpt
    End Function
