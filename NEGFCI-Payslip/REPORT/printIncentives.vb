...
Public Class printIncentives
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEGFCI_Payslip.printIncentives.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintIncentives
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printIncentives = New printIncentives()
        rpt.Site = Me.Site
        Return rpt
    End Function
